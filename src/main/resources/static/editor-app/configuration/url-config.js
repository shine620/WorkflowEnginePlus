...
FLOWABLE.URL = {
    ...
    getModel: function(modelId) {
        return FLOWABLE.CONFIG.contextRoot + '/ModelController/models/'+modelId+'/editor/json?version=' + Date.now();
    },

    newModelInfo: function () {
        return FLOWABLE.CONFIG.contextRoot + '/ModelController/models/newModelJson/';
    },
    ...
    putModel: function(modelId) {
        return FLOWABLE.CONFIG.contextRoot +'/ModelController/models?modelId='+modelId;
